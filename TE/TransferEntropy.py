...
#conditionalprob = conditional_prob(1, 1, joinprob)
...
for j in [1, 2, 4, 5]:
    ...
    for i in range(1, 2500):
        transfentropy = te(1, 1, i, Rbined, Dbined)
        te_sp_dst.append(transfentropy)
    ...
    for i in range(1, 2500):
        transfentropy = te(1, 1, i, Dbined, Rbined)
        te_dst_sp.append(transfentropy)
...
#transfentropy2 = transferEntropy_case(df, 2, 2, 1)
#print(transfentropy2)
